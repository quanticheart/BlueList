...
import com.quanticheart.core.base.fragment.BaseFragmentDataBinding
...
class ToDoDetailsFragment :
    BaseFragmentDataBinding<ToDoDetailsViewModel, FragmentToDoDetailsBinding>(R.layout.fragment_to_do_details) {
    override fun view(binding: FragmentToDoDetailsBinding) {
    ...
    override fun viewModel(viewModel: ToDoDetailsViewModel) {
        viewModel.apply {
