...
object ViewBinding {
    ...
    internal fun <T : ViewBinding> getInflateWithLayoutInflater(viewBindingClass: Class<T>): InflateViewBinding<T> {
        return inflateCache.getOrPut(viewBindingClass) { GenericBinding(viewBindingClass) } as InflateViewBinding<T>
    }
...
internal fun <VB : ViewBinding> GenericBinding(viewBindingClass: Class<VB>): InflateViewBinding<VB> {
